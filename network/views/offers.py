...
from offer.models import (
    Offer, Category, Advertiser, Currency, Goal,
    TrafficSource, OfferTrafficSource, Payout
)
...
class PayoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payout
        fields = (
            'revenue', 'payout', 'countries',
            'goal_value', 'type', 'currency', 'goal'
        )
...
class AdvertiserSerializer(serializers.ModelSerializer):
    class Meta:
        model = Advertiser
        fields = (
            'company', 'email', 'contact_person',
            'messenger', 'site', 'comment',
        )
...
class OfferSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Offer
        fields = (
            'id', 'title', 'description', 'tracking_link',
            'preview_link', 'countries', 'categories',
            'traffic_sources', 'status', 'advertiser', 'payouts',
        )
...
class OfferListView(generics.ListAPIView):
    ...
    queryset = Offer.objects.all()  # ✅ Updated
